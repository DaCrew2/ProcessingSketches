...
void setup() {
  ...
  PImage friends = loadImage("13926366433.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
 ...
 mustache = loadImage("images.png"); // 5. Change this to match your file name.
}
...
image(mustache,mouseX-100,mouseY-50);  // 7. Change the line above so that the mustache moves with the mouse.
}
